...
const MockPostCard = () => {
    ...
    return (
        <PostCard
            title={mockPostCardProps.title}
            authors={mockPostCardProps.authors}
            createdAt={mockPostCardProps.createdAt}
            description={mockPostCardProps.description}
            comments={mockPostCardProps.comments}
            id={mockPostCardProps.id}
            updatedAt={mockPostCardProps.updatedAt}
        />
    )
}

describe('<PostCard /> component testing', () => {
    it('should render title, authors, and description', () => {
        render(<MockPostCard/>)
        ...
        const updatedTimeEle = screen.getByTestId('updatedTime')
        expect(updatedTimeEle).toBeInTheDocument()

        const descriptionEle = screen.getByTestId('description')
